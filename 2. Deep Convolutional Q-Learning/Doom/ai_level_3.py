...
doom_env = image_preprocessing.PreprocessImage(SkipWrapper(4)(ToDiscrete("minimal")(gym.make("ppaquette/DoomDefendCenter-v0"))), width = 80, height = 80, grayscale = True)
