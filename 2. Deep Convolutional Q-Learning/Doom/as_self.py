...
class CNN(nn.Module):
    ...
    '''
        ...
        and makes it easier for us to switch environments and easily get the 
        actions the agent is allowed to perform. This will help if we change to 
        other environments.
        
        Architecture of the Brain: we start with 3 convolutions layers(give us high 
        level of feature detection) fc1 and fc2 are the full connections connecting 
        the convolution layer to hidden and hidden to output layers
    ...
    def __init__(self, number_actions):
        ...
        # the original image. common practise is to use 2X2, 3X3 or 5X5
    ...
    def forward(self, x):
        ...
        # Propagating x through the fully connected layer ad=nd using relu to 
        # break the linearity
